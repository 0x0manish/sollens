...
import { FileText, Activity, Code, Server, Clock } from "lucide-react";

export function TransactionAnalysisLoading() {
  return (
      ...
      <div className="py-10 w-full max-w-md mx-auto flex flex-col items-center">
        ...
        <div className="relative w-64 h-64 mb-8">
          ...
          <div className="absolute inset-0 animate-spin" style={{ animationDuration: '8s', animationDelay: '3s' }}>
            <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 bg-slate-700 p-2 rounded-full border border-slate-600 shadow-lg">
              <Server className="h-5 w-5 text-emerald-500" />
            </div>
          </div>
          
          {/* Center pulsing transaction icon */}
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <h2 className="text-2xl font-bold mb-2">Analyzing Transaction</h2>
          <p className="text-slate-400 mb-4 max-w-xs">
            Fetching blockchain data and decoding instructions...
          </p>
