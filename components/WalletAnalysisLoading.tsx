...
import { Wallet, Shield, BarChart3, User, Activity } from "lucide-react";

export function WalletAnalysisLoading() {
  return (
    <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 flex flex-col items-center">
      <div className="py-10 w-full max-w-md mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <h2 className="text-2xl font-bold mb-2">Analyzing Wallet</h2>
          <p className="text-slate-400 mb-4 max-w-xs">
            Processing on-chain data and risk metrics...
          </p>
